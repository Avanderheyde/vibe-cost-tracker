...
describe("Store", () => {
  ...
  describe("subscriptions", () => {
    ...
    it("adds a subscription", () => {
      const sub = store.addSubscription({
        ...
        billingCycle: "monthly", category: "ai-models", projectId: null, isActive: true, quantity: 1, nextPaymentDate: null,
      })
    ...
    it("updates a subscription", () => {
      const sub = store.addSubscription({
        ...
        billingCycle: "monthly", category: "services", projectId: null, isActive: true, quantity: 1, nextPaymentDate: null,
      })
    ...
    it("gets subscriptions by project", () => {
      ...
      store.addSubscription({
        ...
        billingCycle: "monthly", category: "services", projectId: project.id, isActive: true, quantity: 1, nextPaymentDate: null,
      })
      store.addSubscription({
  ...
  describe("calculations", () => {
    it("calculates monthly total for active subs only", () => {
      ...
      store.addSubscription({
        ...
        billingCycle: "yearly", category: "dev-tools", projectId: null, isActive: true, quantity: 1, nextPaymentDate: null,
      })
      store.addSubscription({
        name: "C", provider: "Z", cost: 50,
        billingCycle: "monthly", category: "services", projectId: null, isActive: false, quantity: 1, nextPaymentDate: null,
      })
    ...
    it("multiplies cost by quantity for monthly (seats)", () => {
      store.addSubscription({
        ...
        billingCycle: "monthly", category: "productivity", projectId: null, isActive: true, quantity: 2, nextPaymentDate: null,
      })
      // 12 * 2 seats = 24/mo
    ...
    it("ignores quantity for yearly (years prepaid)", () => {
      store.addSubscription({
        ...
        billingCycle: "yearly", category: "services", projectId: null, isActive: true, quantity: 2, nextPaymentDate: null,
      })
    ...
    it("calculates monthly total per project", () => {
      ...
      store.addSubscription({
        name: "A", provider: "X", cost: 20,
        billingCycle: "monthly", category: "ai-models", projectId: p.id, isActive: true, quantity: 1, nextPaymentDate: null,
      })
      store.addSubscription({
        name: "B", provider: "Y", cost: 10,
        billingCycle: "monthly", category: "dev-tools", projectId: null, isActive: true, quantity: 1, nextPaymentDate: null,
      })
    ...
    it("calculates totals by category", () => {
      ...
      expect(byCategory["ai-models"]).toBe(30)
  ...
  describe("nextPaymentDate", () => {
    it("round-trips through add, update, and export/import", async () => {
      const sub = store.addSubscription({
        name: "Claude Pro", provider: "Anthropic", cost: 20,
        billingCycle: "monthly", category: "ai-models", projectId: null, isActive: true, quantity: 1, nextPaymentDate: "2025-03-15",
      })
